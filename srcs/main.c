...
{
	if (data->map[(int)((data->player.pos.y + y) / 50)][(int)((data->player.pos.x + x
				+ 6) / 50)] == '1')
		return (1);
	if (data->map[(int)((data->player.pos.y + y + 6) / 50)][(int)((data->player.pos.x
				+ x) / 50)] == '1')
		return (1);
	if (data->map[(int)((data->player.pos.y + y - 6) / 50)][(int)((data->player.pos.x
				+ x - 6) / 50)] == '1')
	...
	if (data->map[(int)((data->player.pos.y + y + 6) / 50)][(int)((data->player.pos.x
				+ x) / 50)] == '1')
		return (1);
	if (data->map[(int)((data->player.pos.y + y - 3) / 50)][(int)((data->player.pos.x
				+ x - 3) / 50)] == '1')
		return (1);
	if (data->map[(int)((data->player.pos.y + y + 3) / 50)][(int)((data->player.pos.x
				+ x - 3) / 50)] == '1')
